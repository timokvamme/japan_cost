function [OutliersNaN, DataZs, PrunedData, OutliersFlagged, NoOutliers] = BenStuff_MADoutlierRmNaN( Data,CriticalZ)
...
%   OutliersNaN   contains all data but replaces outliers with NaNs
%
%
...
if iscell(Data)
    ...
    if length(Medians)>1 %if Data is 2D
       ...
       OutliersNaN=Data;
       OutliersNaN(OutliersFlagged)=NaN;
    else
